...
void omc_combination() {
    ...
    TFile* file_combined = new TFile ("/home/valerian/programs/atom_progs/combined.root", "RECREATE");
    ...
    TFile* file_gamma_jets = new TFile ("/home/valerian/programs/atom_progs/gamma_jets.root", "READ");
    TFile* file_znunu = new TFile ("/home/valerian/programs/atom_progs/Z_nunu.root", "READ");
